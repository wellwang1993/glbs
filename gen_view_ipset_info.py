...
def gen_country_view():
    ...
    for line in res:
        view_country = line[0]
        sql = 'insert into Polaris_tb_fact_temp_view_info(view_father_id,view_default,view_country,view_grade_name,view_grade,view_father_grade,view_type_id) values(0,"default","{}","country",2,1,1)'.format(view_country)
        res = my_custom_sql(sql)
