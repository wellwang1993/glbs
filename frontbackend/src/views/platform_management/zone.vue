...
<script>
import { generateConfig, fetchDnstype, fetchZone, deleteid, fetchList, create, update } from '@/api/zone'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchList({ 'zonename': this.search_temp.zone_name, 'page': this.page, 'size': this.limit }).then(response => {
