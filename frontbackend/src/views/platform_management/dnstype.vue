<template>
  <div class="app-container">
    <div class="filter-container" :model="search_temp">
      <el-input v-model="search_temp.dns_name" placeholder="dnsname" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="dnsname" width="350px" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="Name" prop="dnsname">
          <el-input v-model="temp.dns_name" />
        </el-form-item>
        <el-form-item label="Status" prop="dnsstatus">
...
<script>
import { deleteid, fetchList, create, update } from '@/api/dnstype'
...
export default {
  ...
  data() {
    return {
      ...
      pvData: [],
      rules: {
        dnsname: [{ required: true, message: 'dns name is required', trigger: 'blur' }],
        dnsstatus: [{ required: true, message: 'status is required', trigger: 'blur' }]
      }
    }
  },
  created() {
  ...
  methods: {
    getList() {
      ...
      fetchList({ 'dnstype': this.search_temp.dns_name, 'page': this.page, 'size': this.limit }).then(response => {
